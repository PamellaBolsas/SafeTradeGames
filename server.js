...
app.post('/api/balance/withdraw', authMiddleware, (req, res) => {
    try {
        ...
        console.log('Saldo disponível do usuário:', user.availableBalance);
        ...
        console.log('Novo saldo disponível após saque:', user.availableBalance);
        ...
        // Também emitir para o socket específico do usuário se necessário
        ...
        res.json({
            ...
            newBalance: user.availableBalance // Enviar novo saldo na resposta
        });
